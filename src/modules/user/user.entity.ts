...
export class User extends BaseEntity{
  ...
  /**
   * cascade: cuando se cree un detalle y se asigne a un usuario, automáticamente se creará en la db
   * nullable
   * eager: cada vez que se haga un select a la entidad automáticamente se traerá un detalle
   */
